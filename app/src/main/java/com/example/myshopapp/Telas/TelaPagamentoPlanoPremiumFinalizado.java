...
public class TelaPagamentoPlanoPremiumFinalizado extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tela_pagamento_plano_premium_finalizado);

        inicializarVariaveis_TelaPagamentoPlanoPremiumFinalizado();
        eventos();
    }

    public void inicializarVariaveis_TelaPagamentoPlanoPremiumFinalizado(){
